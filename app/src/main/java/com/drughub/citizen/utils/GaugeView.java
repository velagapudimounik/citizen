...
public class GaugeView extends View {
    ...
    public static final int INNER_CIRCLE_COLOR = Color.TRANSPARENT;
    public static final int OUTER_CIRCLE_COLOR = Color.TRANSPARENT;
...
//        mOuterCircleColor = a.getColor(R.styleable.GaugeView_outerCircleColor, OUTER_CIRCLE_COLOR);
    ...
    public Paint getDefaultOuterRimPaint() {
        ...
        final Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.colorimage);
...
//            mRangePaints[i].setStrokeWidth(0.005f);
            mRangePaints[i].setTextSize(0.00f);
...
//            if ((Math.abs(mod - 0) < 0.001) || (Math.abs(mod - div) < 0.001)) {
            ...
            canvas.drawLine(0.5f, y1 - 0.050f, 0.5f, y3 - 0.03f, paint);
